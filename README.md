...
**Feed:**
The feed contains security feeds from places like the UN Relief Web and the US Centers for Disease Control. You enter your location (and how often you want to be updated). Everytime a new update is released (e.g a disease outbreak in your location), the information comes up on the dashboard.
...
**Tool Guides:**
These are detailed guides about how to use the software and apps mentioned in the lessons.
