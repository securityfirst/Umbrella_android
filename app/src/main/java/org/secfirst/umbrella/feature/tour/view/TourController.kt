...
import org.secfirst.umbrella.feature.content.ContentService.Companion.ACTION_COMPLETED_FOREGROUND_SERVICE
import org.secfirst.umbrella.feature.content.ContentService.Companion.EXTRA_CONTENT_SERVICE_ID
import org.secfirst.umbrella.feature.content.ContentService.Companion.EXTRA_CONTENT_SERVICE_PROGRESS
import org.secfirst.umbrella.feature.content.ContentService.Companion.EXTRA_CONTENT_SERVICE_TITLE_PROGRESS
...
import org.secfirst.umbrella.feature.tour.DaggerTourComponent
import org.secfirst.umbrella.misc.isInternetConnected
...
class TourController : BaseController(), ContentView {
    ...
    init {
        ...
        viewList.add(TourUI(R.color.umbrella_green, R.drawable.ic_walkthrough1, org.secfirst.umbrella.R.string.tour_slide_1_text, VISIBLE, GONE))
        viewList.add(TourUI(R.color.umbrella_yellow, R.drawable.ic_walkthrough2, org.secfirst.umbrella.R.string.tour_slide_2_text, VISIBLE, GONE))
        viewList.add(TourUI(R.color.umbrella_purple, R.drawable.ic_walkthrough3, org.secfirst.umbrella.R.string.tour_slide_3_text, VISIBLE, GONE))
        viewList.add(TourUI(R.color.macaroni_and_cheese, R.drawable.walktrough4, org.secfirst.umbrella.R.string.terms_conditions, GONE, VISIBLE))
    }
